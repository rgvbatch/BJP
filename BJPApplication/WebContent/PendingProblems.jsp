      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <center>
              <h3 class="box-title"><u>PendingProblems</u></h3>
</center>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th class="danger">Division Name</th>
                  <th class="warning">Problem Type</th>
                  <th class="success">ProblemDesc</th>
                  <th class="danger">Status</th>
									...
									<%
										try {
											...
											PreparedStatement pstmt = conn.prepareStatement("select constitution,division,problemtype,textarea from problemtable where status is null and constitution=?");
                ...
                <td><form action="${pageContext.request.contextPath}/ApproveProblems.jsp" method="post">
                 
                   <input type="hidden" name="division" value="<%=rs.getString("division") %>"></input>
                   <input type="hidden" name="problemtype" value="<%=rs.getString("problemtype") %>"></input>
                  
                  <button type="submit"><span class="label label-success">Approve</span></button></form></td>
