...
%>
  ...
  <title>View Constitutions</title>
        ...
        <div class="col-xs-8">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title" align="center">Constitutions</h3>
			...
			<div class="table-responsive mailbox-messages">
              <div class="box-body  no-padding">
               <form action="DeleteConstitutions.jsp" method="post" id="form">
                ...
                <%
											try {
												...
												PreparedStatement pstmt = conn.prepareStatement(
														"select constitutiontable.constitution, count(divisiontable.division) FROM constitutiontable LEFT JOIN divisiontable  ON constitutiontable.constitution=divisiontable.constitution group by constitutiontable.constitution");
										...
										%>
                <tr>
                  <td><input type="checkbox" name="check" value="<%=rs.getString("constitution")%>"></td>
                 <td><%=i%></td>
