 ...
 %></br> <small><%=user.getEmail()%></small></br> <small><%=user.getMobile()%></small>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="active treeview"><a href="#"> <i
							class="fa fa-star"></i> <span>Constitutions</span> <span
		...
		<div class="content-wrapper" style="background: url(images/img11.jpg)"no-repeat;>
			...
			<div class="form">
				...
				<div class="container">
					<form action="LoginServlet?name=conreg" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Add Constitution"
									name="constitution" class="form-control" pattern="[a-zA-Z]{0,30}" title="enter aplhabets only max 30 characters" required
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="First Name"
									name="firstname" class="form-control" pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" required
									autocomplete="off" autofocus>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Middle Name"
									name="middlename" class="form-control" pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" autofocus>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Last Name"
									name="lastname" class="form-control" pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" required
									autocomplete="off" autofocus>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Password"
									name="password" class="form-control" pattern="((?=.*\d)(?=.*[A-Z])(?=.*\W).{8,16})" title="password must atleast contain one uppercase letter,one lowercase letter, one special character and one one number with min 8 and max 16 characters"  required
									autocomplete="off" autofocus>
							</div>
						</div>
						<div class="form-group">
								...
								<div class="row">
									<div class="radio-inline">
										<label><input type="radio" name="gender"
											value="Female" required autocomplete="off">Female</label>
									</div>
									<div class="radio-inline">
									...
									<div class="radio-inline">
										<label><input type="radio" name="gender" value="other"
											required autocomplete="off">other</label>
									</div>
								</div>
							</div>
						</div>
