      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <center>
              <h3 class="box-title"><u>SuccessProblems</u></h3>
</center>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th class="danger">Problem Desc</th>
									...
									<%
										try {
											...
											PreparedStatement pstmt = conn.prepareStatement("select constitution,division,problemtype,textarea from problemtable where status=? and constitution=?");
