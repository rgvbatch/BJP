		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="LoginServlet" method="post">
					<span class="login100-form-title"> DivisionLogin </span> <input
						type="hidden" name="name" value="division"></input>
					<div class="wrap-input100 validate-input"
						data-validate="username is required">
						<input class="input100" type="text" name="username"
							placeholder="UserName" required> <span class="focus-input100"></span>
					...
					<div>
						...
						<p style="color: red;">&ensp;&ensp;&ensp;&ensp;&ensp;x Invalid
							Username or Pass word
					</div>
