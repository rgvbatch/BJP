						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" name="firstname"
									placeholder="First Name" class="form-control"  pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" required
									autocomplete="off" autofocus>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" name="middlename"
									placeholder="Middle Name" class="form-control"  pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" autofocus>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" name="lastname"
									placeholder="Last Name" class="form-control"  pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" required
									autocomplete="off" autofocus>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" name="password"
									placeholder="Password" class="form-control" pattern="((?=.*\d)(?=.*[A-Z])(?=.*\W).{8,16})" title="password must atleast contain one uppercase letter,one lowercase letter, one special character and one one number with min 8 and max 16 characters" required
									autocomplete="off" autofocus>
							</div>
						</div>
						<div class="form-group">
