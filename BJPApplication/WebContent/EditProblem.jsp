 ...
 %></br> <small><%=user.getEmail()%></small></br> <small><%=user.getMobile()%></small>
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="DivisionLogout.jsp" class="btn btn-default btn-flat">Sign
											out</a>
									</div>
								</li>
							</ul></li>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="active"><a href="divisionhome.jsp"> <i
							class="fa fa-dashboard"></i> <span>Home</span> <span
							class="pull-right-container"> </span>
					</a></li>
					<li class="active"><a href="AddProblems.jsp"> <i
							class="fa fa-star"></i> <span>Add Problems</span>

					</a></li>
					<li class="active"><a href="ViewDivisionProblems.jsp"> <i
							class="fa fa-star"></i> <span>View Problems</span>
		...
		<div class="content-wrapper" style="background: url(images/img66.png)"no-repeat;>
			...
			<div class="form">
				...
				<div class="container">
					<form action="LoginServlet?name=EditProblem" method="post"
						class="form-horizontal" role="form">
						<center><h2>Edit Profile</h2></center>

						<div class="form-group">
							<label for="firstName" class="col-sm-3 control-label">Constitution<span
								class="req">*</span></label>
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Add Constitution"
									name="constitution" value=<%=user.getConstitution()%>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Add Constitution"
									name="division" value=<%=user.getDivision()%>
									readonly="readonly" class="form-control" required
									autocomplete="off" autofocus>
							</div>
						</div>
						<%
							...
							PreparedStatement pstmt = conn.prepareStatement(
									"select * from problemtable where constitution=? and division=? and problemtype=?");
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="First Name"
									name="firstname" value=<%=rs.getString("firstname")%>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Middle Name"
									name="middlename" value=<%=rs.getString("middlename")%>
									class="form-control" required autocomplete="off" autofocus>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Last Name"
									name="lastname" value=<%=rs.getString("lastname")%>
									class="form-control" required autocomplete="off" autofocus>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="firstName" placeholder="Email"
									...
									class="form-control"
									pattern="[a-z.]*[@]\b((yahoo.com)||(hotmail.com)||(gmail.com)||(outlook.com))"
                    ...
                    <div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="mobile" id="phone"
									placeholder="Mobile Number" value=<%=rs.getString("mobile")%>
									class="form-control"
						...
						<div class="form-group">
							<label for="firstName" class="col-sm-3 control-label">ProblemType<span
								class="req">*</span></label>
							<div class="col-sm-9">
								<select id="country" name="problemtype" class="form-control"
									required autocomplete="off">

									<option name="problemtype"
										><%=rs.getString("problemtype")%></option>
								</select>
							</div>
						</div>
						<div>
							<label for="firstname" class="col-sm-3 control-label" name="textarea">
								Write your problem<span
								class="req">*</span> </label>
								<div class="col-sm-9">
							<textarea class="form-control" rows="5"" name="textarea" required="required"
								placeholder="enter your problem here"
								><%=rs.getString("textarea")%></textarea>
								</div>
						</div>
						<%-- <div class="form-group">
							<label for="firstName" class="col-sm-3 control-label">
								Enter Problem<span class="req">*</span>
							</label>
							<div class="col-sm-9">

								<textarea class="form-control" rows="5" id="comment" type="text"
									name="textarea" ") value=<%=rs.getString("textarea")%>> </textarea>
							</div>
						</div> --%>
						<%
							}
