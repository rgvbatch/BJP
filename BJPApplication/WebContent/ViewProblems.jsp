...
<body class="hold-transition skin-blue  sidebar-mini">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="ConstitutionHome.jsp" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>Cons</b></span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b><%=user.getConstitution()%></b></span>
			</a>
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="ConstituionProfile.jsp"
											class="btn btn-default btn-flat">EditProfile</a>
									</div>
									<div class="pull-right">
										<a href="ConstitutionLogout.jsp"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="active"><a href="ConstitutionHome.jsp"> <i
							class="fa fa-home"></i> <span>HOME</span> <span
							class="pull-right-container"> </span>
					</a></li>
					<li class="active"><a href="ViewConstitutionDivisions.jsp">
							<i class="fa fa-eye"></i> <span>viewdivisions</span> <span
							class="pull-right-container"> </span>
					</a></li>
					</a>
					<li class="treeview"><a href="#"> <i class="fa  fa-lock"></i>
							<span>Problems</span> <span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li class="active"><a href="PendingProblems.jsp"><i
									class="fa fa-question-circle"></i> pending problems</a></li>

							<li class="active"><a href="SuccessProblems.jsp"><i
									class="fa fa-thumbs-up"></i> success problems</a></li>
