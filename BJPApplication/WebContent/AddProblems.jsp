     ...
     <div class="container">
            <form action="LoginServlet?name=regProblem" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="firstname" id="firstName" placeholder="First Name" name="firstname" class="form-control" pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" required autocomplete="off" autofocus>   
                    </div>
                </div>
				<div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Middle Name</label>
                    <div class="col-sm-9">
                        <input type="text" name="middlename" id="firstName" placeholder="Middle Name" name="middlename" class="form-control" pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" autofocus>   
                    </div>
                </div>
				<div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Last Name<span class="req">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" name="lastname" id="firstName" placeholder="Last Name" name="lastname" class="form-control" pattern="[a-zA-Z]{0,20}" title="enter aplhabets only max 20 characters" required autocomplete="off" autofocus>   
                    </div>
                </div>
