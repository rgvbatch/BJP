    ...
    <section class="content">
      ...
      <div class="row">
					...
					try {
						...
						PreparedStatement pstmt = conn.prepareStatement("select constitutiontable.constitution, count(problemtable.constitution) FROM constitutiontable Left JOIN problemtable  ON constitutiontable.constitution=problemtable.constitution group by problemtable.constitution,constitutiontable.constitution");
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <p>Constitution Name::<%=rs.getString("constitution") %><p>
            ...
            <a href="InfoDivisions.jsp?view=<%=rs.getString("constitution")%>"><font color="white">More Info<i class="fa fa-arrow-circle-right"></i></font></a>
          </div>
        </div>
        </div>
