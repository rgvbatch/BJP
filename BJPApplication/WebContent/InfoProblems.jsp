...
%>
	...
	<div class="row">
				...
				<div class="col-xs-8">
					...
					PreparedStatement pstmt = conn.prepareStatement("SELECT CONSTITUTION,PROBLEMTYPE,TEXTAREA  FROM problemtable WHERE division=? and constitution=?");
...
<%
								...
								<%String cons = request.getParameter("cons"); %>
								<form action="InfoDivisions.jsp?view=<%=cons %>" method="post">
