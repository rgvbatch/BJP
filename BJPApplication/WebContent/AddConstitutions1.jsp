...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="AddConstitutions.jsp"><i class="fa fa-plus-square"></i> Add Constitutions</a>

			</li>
            <li><a href="ViewConstitution.jsp"><i class="fa fa-circle-o"></i> View Constitutions</a></li>
          </ul>
        </li>
		<li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="AddDivisions.jsp"><i class="fa fa-plus-square"></i> Add Divisions</a></li>
            <li><a href="ViewDivision.jsp"><i class="fa fa-circle-o"></i> View Divisions</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <center><h3 style="color:red;">Registration Failed</h3></center><br>
   <center><h4 style="color:red;">Constitution name already exists</h4></center>
    <!-- Content Header (Page header) -->

			<div class="form">
     
     <div class="container">
            <form action="LoginServlet?name=conreg" method="post" class="form-horizontal" role="form">
                <h2>Add Constitution</h2>
				
				<div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Constitution<span class="req">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName" placeholder="Add Constitution" name="constitution" class="form-control" required autocomplete="off" autofocus>   
                    </div>
                </div>
                <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">First Name<span class="req">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName" placeholder="First Name" name="firstname" class="form-control" required autocomplete="off" autofocus>   
                    </div>
                </div>
				<div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Middle Name</label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName" placeholder="Middle Name" name="middlename" class="form-control" autofocus>   
                    </div>
                </div>
				<div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Last Name<span class="req">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName" placeholder="Last Name" name="lastname" class="form-control" required autocomplete="off" autofocus>   
                    </div>
                </div>
                <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">User Name<span class="req">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName" placeholder="User Name" name="username" class="form-control" required autocomplete="off" autofocus>   
                    </div>
                </div>
                <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Password<span class="req">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName" placeholder="Password" name="password" class="form-control" required autocomplete="off" autofocus>   
                    </div>
                </div>
                <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Email<span class="req">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName"  placeholder="Email" name="email" class="form-control" pattern="[a-z0-9._%+-]*[@]\b((yahoo.com)||(hotmail.com)||(gmail.com)||(outlook.com))" required autocomplete="off" autofocus>   
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="mobile" id="phone" placeholder="Mobile Number" class="form-control" onkeypress = "return AllowNumbersOnly(event)" required autocomplete="off" autofocus maxlength="10" minlength="10">   
                    </div>
                </div>
                <div class="form-group">
