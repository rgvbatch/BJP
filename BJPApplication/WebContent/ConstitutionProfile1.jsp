...
<aside class="main-sidebar">
 ...
 <div class="content-wrapper">
  ...
  <center><h1 style="color:red;">Profile Update Failed</h1></center><br>
   <center><h2 style="color:red;">Try Again</h2></center>
    <!-- Content Header (Page header) -->
     ...
     <div class="container">
            <form action="LoginServlet?name=editconsprofile" method="post" class="form-horizontal" role="form">
               ...
               <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Middle Name</label>
                    <div class="col-sm-9">
                        <input type="text" id="firstName" placeholder="Middle Name" name="middlename" value=<%=user.getMiddlename() %> class="form-control" autofocus>   
                    </div>
                </div>
                <%} %>
